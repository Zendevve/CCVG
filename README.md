...
<div align="center">
    ...
    <br>
    <a href="LICENSE">
        <img src="https://img.shields.io/badge/License-Source%20Available-orange.svg?style=for-the-badge" alt="Source Available" />
    </a>
...
> **RESTRICTED LICENSE:**
>
> - **Source Available** for personal use and modification.
> - **Redistribution** of source code or binaries is STRICTLY PROHIBITED.
> - **No Commercial Use** allowed without permission.
> - See [LICENSE](LICENSE) for full specific terms.
...
- **[LICENSE](LICENSE)** - Full Source Available License terms
...
Distributed under a custom **Source Available License**. See `LICENSE` for more information.

- **Source Code**: Available for personal use and modification.
- **Redistribution**: Strictly prohibited for both source and binaries.
- **Commercial Use**: Prohibited without express permission.
- **Binaries**: Official binaries are distributed exclusively by Zendevve.
